...
public class MainGUI {
    ...
    public MainGUI() {
        ...
        creatorsButton.addActionListener(e -> {
            String info = "<html><b>Creator 1:</b><br>Name: Placeholder Name 1<br>Register No: Placeholder 123<br>Department: Computer Science<br>Year: 3rd Year<br><br>" +
                    "<b>Creator 2:</b><br>Name: Placeholder Name 2<br>Register No: Placeholder 456<br>Department: Information Technology<br>Year: 3rd Year</html>";
