...
public class FFile {
    ...
    public FFile(String filename, String path){
        ...
        this.path=path;
        Storer s=db.getStorer(filename,path,"Test");
        Storer d=db.getStorer(filename,path,"Production");
    ...
    public FileDS setFileDS(String scope){
        ...
        if(s==null){
            FileDS cur=new FileDS(getContentFromfile(),1);
    ...
    public static void main(String[] args) {
        FFile f=new FFile("Armstrong.html","C:\\Users\\User\\Documents\\2-6-23");
        List<Log> l=f.logs;
        for(Log a:l){
            System.out.println(a.scope);
        }
    }
